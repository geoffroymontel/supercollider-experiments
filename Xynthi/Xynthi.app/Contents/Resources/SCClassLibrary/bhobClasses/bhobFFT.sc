PV_CommonMag : UGen 
{
	*new { arg bufferA, bufferB, tolerance=0.0, remove=0.0, shift=0, stretch=1;
		^this.multiNew('control', bufferA, bufferB, tolerance, remove, shift, stretch)
	}
}
...
PV_MagScale : UGen 
{
	*new { arg bufferA, bufferB, shift=0, stretch=1;
		^this.multiNew('control', bufferA, bufferB, shift, stretch)
	}
}
