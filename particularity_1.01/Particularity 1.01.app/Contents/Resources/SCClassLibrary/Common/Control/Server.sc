...
Server : Model {
	...
	var <>options, <>latency = nil, <dumpMode = 0, <notified=true;
	var <nodeAllocator;
	...
	var alive = false, booting = false, aliveThread, <>aliveThreadPeriod = 0.2, statusWatcher;
	var <>tree;
